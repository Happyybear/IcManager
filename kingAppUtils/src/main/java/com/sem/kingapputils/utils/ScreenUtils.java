 ...
 * @Author: king
 * @CreateDate: 2021/5/10 8:59
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/5/10 8:59
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class ScreenUtils {
    ...
    {
       return QMUIDisplayHelper.getRealScreenSize(Utils.getApp());
    }
    /**
     ...
     * 隐藏导航栏
     */
    public static void hideNavigation(@NonNull final AppCompatActivity activity){
