package com.sem.kingapputils.utils.okhttp;
 ...
 * @Description: Http简单封装，为了缴费模块使用
 * @Author: king
 * @CreateDate: 2022/5/24 9:05
 * @UpdateUser: 更新者
 * @UpdateDate: 2022/5/24 9:05
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class OkHttpUtil {
    ...
    public OkHttpUtil addParam(Map<String, String> value) {
        if (!KArrayUtils.isEmptyMap(value)){
            if (paramMap == null) {
                paramMap = new LinkedHashMap<>(16);
            }
            paramMap.putAll(value);
            return this;
        }
        return this;
    }
