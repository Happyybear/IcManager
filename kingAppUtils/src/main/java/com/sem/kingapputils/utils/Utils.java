 ...
 * @Author: king
 * @CreateDate: 2021/5/8 16:26
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/5/8 16:26
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class Utils {
    ...
    private static final String PERMISSION_ACTIVITY_CLASS_NAME =
            "com.king.sem.util.PermissionUtils$PermissionActivity";
    ...
    public static String getPdfDir(){
       return getApp().getExternalFilesDir("PDF").getAbsolutePath();
    }
    /**
     * Init utils.
     * <p>Init it in the class of Application.</p>
    ...
    static class ActivityLifecycleImpl implements ActivityLifecycleCallbacks {
        ...
        private Activity getTopActivityByReflect() {
            try {
                ...
                Field mActivityListField = activityThreadClass.getDeclaredField("mActivities");
                mActivityListField.setAccessible(true);
                Map activities;
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
                    activities = (HashMap<Object, Object>) mActivityListField.get(activityThread );
                } else {
                    activities = (ArrayMap<Object, Object>) mActivityListField.get(activityThread );
                }
